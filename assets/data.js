...
const ULSOO_I18N = {
  ko: {
    ...
    projects: [
      ...
      { id: "curation-platform", title: "지능형 큐레이션 플랫폼", subtitle: "국립중앙박물관 실증", desc: "학예사가 직접 쓰는 애셋 검색·관리 도구. 소장기관·시대·재질로 좁히거나 자연어로 물어 전시에 쓸 유물을 찾습니다. 애셋관리자·큐레이터·일반사용자로 권한을 나눠 설계했습니다.", tag: "큐레이션 플랫폼", icon: "layout-grid", link: "", img: "assets/img/case-curation.webp", hasBadge: false },
      { id: "detection", title: "기록화 속 인물 자동 검출", subtitle: "행렬 기록화 객체 인식", desc: "왕의 행차를 그린 기록화에서 병사·문관·기수·말을 한 번에 찾아냅니다. 학습 이미지가 부족한 옛 그림은 Style Transfer로 데이터를 보강해 인식 성능을 끌어올렸습니다.", tag: "객체 검출", icon: "scan-search", link: "", img: "assets/img/case-detection.webp", hasBadge: false }
    ],
  ...
  en: {
    ...
    projects: [
      ...
      { id: "curation-platform", title: "Intelligent curation platform", subtitle: "Demonstrated at the National Museum of Korea", desc: "An asset search and management tool curators use themselves. Narrow by holding institution, period or material, or ask in plain language, to find objects for an exhibition. Roles are split across asset managers, curators and general users.", tag: "Curation platform", icon: "layout-grid", link: "", img: "assets/img/case-curation.webp", hasBadge: false },
      { id: "detection", title: "Figure detection in record paintings", subtitle: "Object recognition on procession scrolls", desc: "Soldiers, officials, standard-bearers and horses are found in a single pass across a painted royal procession. For old paintings, where training images are scarce, style transfer augmented the data to lift recognition performance.", tag: "Object detection", icon: "scan-search", link: "", img: "assets/img/case-detection.webp", hasBadge: false }
    ],
